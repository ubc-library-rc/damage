...
**Why is there no binary version of [release]?**

* Damage is developed off the side of my desk. Compiling can take time away from the other things that need doing, and also requires access to multiple platforms.
...
* As of v0.5.0+, the command line version of _damage_ will give you progress meters to let you know what's happening. Also, it's way faster.
